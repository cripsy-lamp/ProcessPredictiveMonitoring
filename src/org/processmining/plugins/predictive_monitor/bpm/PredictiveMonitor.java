...
public class PredictiveMonitor extends AbstractProvider {
	...
	@UITopiaVariant(affiliation = UITopiaVariant.EHV, author = "F.M. Maggi et al.", email = "F.M.Maggi@ut.ee", uiLabel = "Predictive Monitor", pack = "PredictiveMonitor")
	@PluginVariant(variantLabel = "Predictive Monitoring", requiredParameterLabels = { 0})
