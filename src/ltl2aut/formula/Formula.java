...
public class Formula extends LTLFormula implements Cloneable, Iterable<String> {
	final int hashCode;
	...
	public Formula clone() {
		...
		if (getLeft() != null) {
			clone.setLeft(getLeft().clone());
		}
		if (getRight() != null) {
			clone.setRight(getRight().clone());
		}
